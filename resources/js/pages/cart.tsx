                    ...
                    <div className="flex flex-col lg:flex-row gap-12">
                        ...
                        <div className="w-full lg:w-3/5 space-y-10">
                            ...
                            <div className="border border-gray-200 rounded-md p-6 relative">
                                <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-white px-2 text-xs text-gray-500">
                                    Express Checkout
                                </div>
                            ...
                            <div className="relative">
                                ...
                                <div className="relative flex justify-center text-xs text-gray-500 bg-white px-4 w-max mx-auto">
                                    Or continue below
                                </div>
                            </div>
                            ...
                            <div className="space-y-4">
                                ...
                                <Input type="email" placeholder="Email address" className="h-12 border-gray-300 rounded-sm" />
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="space-y-4">
                                    <div className="border border-gray-300 rounded-sm px-3 py-2 relative">
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <Input placeholder="First name" className="h-12 border-gray-300 rounded-sm" />
                                        <Input placeholder="Last name" className="h-12 border-gray-300 rounded-sm" />
                                    </div>
                                    
                                    <Input placeholder="Address" className="h-12 border-gray-300 rounded-sm" />
                                    
                                    <button className="text-sm text-blue-600 hover:underline text-left">+ Add apartment, suite, etc.</button>

                                    <div className="grid grid-cols-2 gap-4">
                                        <Input placeholder="City" className="h-12 border-gray-300 rounded-sm" />
                                        <div className="border border-gray-300 rounded-sm px-3 py-1 relative flex flex-col justify-center">
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <Input placeholder="Postal code" className="h-12 border-gray-300 rounded-sm" />
                                        <Input placeholder="Phone (optional)" className="h-12 border-gray-300 rounded-sm" />
                                    </div>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="border border-gray-300 rounded-sm p-4 flex justify-between items-center bg-gray-50/50">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="border border-gray-300 rounded-sm overflow-hidden">
                                    <div className="p-4 flex items-center gap-3 border-b border-gray-200 bg-gray-50/50">
                                        <div className="size-4 rounded-full border-[5px] border-gray-900"></div>
                                        <span className="text-sm font-medium italic font-bold text-blue-900">Pay<span className="text-blue-500">Pal</span></span>
                                    </div>
                                    <div className="p-6 bg-gray-50 flex flex-col items-center justify-center text-center gap-4 text-sm text-gray-600">
                        ...
                        <div className="w-full lg:w-2/5">
                            <div className="border border-gray-200 rounded-sm p-6 sticky top-24 bg-white shadow-sm">
